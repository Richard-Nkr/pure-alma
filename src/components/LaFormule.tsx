  ...
  >
   <div className="mx-auto max-w-5xl px-6 py-20 sm:px-10 sm:py-28">
    ...
    <div className="mt-16 grid items-center gap-12 md:grid-cols-2 md:gap-16">
     <div className="space-y-10 sm:space-y-14">
      {ingredients.map((i) => (
       <div key={i.number} className="grid gap-6 sm:grid-cols-[auto_1fr] sm:gap-10">
        <span className="font-condensed text-6xl font-bold leading-none text-amla-cream/30 sm:text-7xl">
         {i.number}
        </span>
        <div>
     ...
     <div className="relative mx-auto aspect-square w-full max-w-md overflow-hidden rounded-3xl md:order-none">
      <Image
       src="/images/img3.png"
