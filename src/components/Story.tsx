...
export default function Story() {
  return (
    <section id="produit" className="relative overflow-hidden bg-amla-bg">
      <div className="mx-auto grid max-w-6xl items-center gap-12 px-5 py-24 md:grid-cols-2">
        <div>
          ...
          <h2 className="mt-4 font-display text-5xl leading-tight text-amla-blue md:text-6xl">
            Née dans l&apos;Atlas, taillée pour l&apos;effort.
          </h2>
          <p className="mt-6 text-lg leading-relaxed text-amla-muted">
          ...
          <p className="mt-4 leading-relaxed text-amla-muted">
          ...
          <div className="mt-8 flex gap-8">
            {[
              ...
              <div key={i.label} className="flex flex-col items-center gap-1">
                ...
                <span className="font-condensed text-xs uppercase tracking-wide text-amla-muted">
                  {i.label}
                </span>
              </div>
            ))}
