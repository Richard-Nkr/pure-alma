    ...
    <section id="degustation" className="mx-auto max-w-6xl px-5 py-24">
      <div className="grid gap-12 md:grid-cols-[0.9fr_1.1fr] md:items-center">
        <div>
          ...
          <p className="mt-5 leading-relaxed text-cacao-soft">
          ...
          <a
            href="#commander"
            className="mt-8 inline-block rounded-full bg-terracotta px-7 py-3.5 text-base font-semibold text-cream shadow-lg shadow-terracotta/20 transition-transform hover:scale-105"
          >
            J&apos;essaie chez moi
          </a>
        </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          {ideas.map((i) => (
            ...
            >
              ...
              <h3 className="mt-3 font-display text-lg font-bold text-cacao">
                {i.title}
              </h3>
